...
class ResNet:
    ...
    @staticmethod
    def build_resnet_18(width, height, depth, classes, mul_factor, summary, weightsPath=None):
        input_shape = (depth, height, width)
        return ResNet.build(input_shape, classes, basic_block, [2, 2, 2, 2])

    @staticmethod
    def build_resnet_34(width, height, depth, classes, mul_factor, summary, weightsPath=None):
        input_shape = (depth, height, width)
        return ResNet.build(input_shape, classes, basic_block, [3, 4, 6, 3])

    @staticmethod
    def build_resnet_50(width, height, depth, classes, mul_factor, summary, weightsPath=None):
        input_shape = (depth, height, width)
        return ResNet.build(input_shape, classes, bottleneck, [3, 4, 6, 3])

    @staticmethod
    def build_resnet_101(width, height, depth, classes, mul_factor, summary, weightsPath=None):
        input_shape = (depth, height, width)
        return ResNet.build(input_shape, num_outputs, bottleneck, [3, 4, 23, 3])

    @staticmethod
    def build_resnet_152(width, height, depth, classes, mul_factor, summary, weightsPath=None):
        input_shape = (depth, height, width)
        return ResNet.build(input_shape, classes, bottleneck, [3, 8, 36, 3])
		
class ResNet18:
    @staticmethod
    def build(width, height, depth, classes, mul_factor, summary, weightsPath=None):
	    return ResNet.build_resnet_18(width, height, depth, classes, mul_factor, summary, weightsPath=None)
